 ...
 */
customer_router.post("/menu", upload.single("image"), addMenuItem);
 ...
 */
customer_router.put('/menu/update/:id', updateMenuItem);
 ...
 */
customer_router.delete('/menu/delete/:id', deleteMenuItem);
 ...
 */
customer_router.get('/stock', getStock);
 ...
 */
customer_router.post('/stock/add', addStockItem);
 ...
 */
customer_router.put('/stock/update/:id', updateStockItem);
 ...
 */
customer_router.delete('/stock/delete/:id', deleteStockItem);
 ...
 */
customer_router.post('/order/accept/:orderId', acceptOrder);
 ...
 */
customer_router.put('/order/update-status/:orderId', updateOrderStatus);
